 ...
 * or directly:  node --test scripts/__tests__/audit-supply-chain.test.mjs
 */
...
test('full audit returns 0 on current accepted state', () => {
  const r = run();
...
test('--scope cve runs only the CVE pass', () => {
...
test('--scope allowlist runs only the allowlist pass', () => {
...
test('--scope typosquat runs only the typosquat pass', () => {
